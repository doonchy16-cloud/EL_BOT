...
if not exist "data\phase6-data-manifest.json" (
  echo Preparing EL Bot dictionary and Unicode emoji data for first launch...
  powershell -NoProfile -ExecutionPolicy Bypass -File "scripts\materialize-phase6-lexicon.ps1"
  if errorlevel 1 (
    echo.
    echo EL Bot could not prepare its Phase 6 lexical data.
