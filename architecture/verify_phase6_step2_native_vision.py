...
def main():
    ...
    grounding=str(vision.get("grounding_source") or ""); req("canonical frozen Forgey ABC concept memory" in grounding and "output-direction memory" in grounding,"visual content/direction grounding is not canonically separated")
    ...
    collapse=str(vision.get("collapse_prevention") or ""); req("direction-invariant canonical concept memory" in collapse and "concept-identity" in collapse and "direction isolated" in collapse,"visual contrastive semantics do not separate canonical concept identity from output direction")
    ...
    trainer=guarded["vision_train"]; req("def _canonical_source" in trainer and 'encode_source("ABC_TO_EL", target.abc)' in trainer,"visual content is not grounded to the locked canonical ABC concept memory"); req("def _direction_source" in trainer and 'encode_source("EL_TO_ABC", target.el)' in trainer,"visual output direction memory is missing")
