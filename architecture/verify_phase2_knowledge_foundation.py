...
def main() -> None:
    ...
    require(current.snapshot.count > len(seed), "emoji universe must exceed semantic seed")
    if (ROOT / "data" / "unicode" / "emoji-test.txt").is_file():
        ...
        require(current.snapshot.version == "17.0", "unexpected Unicode Emoji version")
    ...
    print(f"✅📚2️⃣ 🌐{current.snapshot.count}✅ 📊✅ 🧿✅ 🧷✅ 📜✅ 🗃️✅ 🤖❌")
