...
def main() -> None:
    ...
    print(f"PHASE6_STEP3_NATIVE_VISION_AUTHORITY_OK selected=G2 params={report.trainable_parameters} vision_params={report.vision_parameters} probes={vision['probe_exact_count']}/{vision['probe_total']} provider=0")
